...
ActiveRecord::Schema.define(version: 20160720151154) do
  ...
  create_table "xbox_achievements", force: :cascade do |t|
  ...
  add_index "xbox_achievements", ["xbox_game_id"], name: "index_xbox_achievements_on_xbox_game_id", using: :btree
  ...
  add_foreign_key "xbox_achievements", "xbox_games"
